...
def order_pay(order_id):
    ...
    private_path =os.path.join(os.path.dirname(__file__), "keys/app_private_2048.txt")
    public_path = os.path.join(os.path.dirname(__file__), "keys/alipay_public_2048.txt")
